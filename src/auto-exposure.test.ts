/**
 * @file Comprehensive tests for the auto-exposure pattern implementation Tests the JSON
 *   Schema-first approach for automatically exposing functionality via MCP tools and REST API
 *   endpoints.
 */
