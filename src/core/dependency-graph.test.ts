...
describe("DependencyGraph", () => {
  ...
  describe("build", () => {
    it("should build dependency graph from files", () => {
      ...
      expect(graph.getDependencies("/project/a.md")).toEqual([
        "/project/b.md",
        "/project/c.md",
      ]);
    ...
    it("should update dependents correctly", () => {
      ...
      expect(graph.getDependents("/project/c.md")).toEqual([
        "/project/a.md",
        "/project/b.md",
      ]);
  ...
  describe("non-node dependency targets (e.g. non-markdown assets)", () => {
    ...
    it("should rewrite references to a renamed path even when it has no graph node of its own", () => {
      ...
      expect(graph.getDependents("/project/assets/image.png")).toEqual([
        "/project/a.md",
      ]);
    });
  });
