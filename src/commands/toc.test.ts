...
`;
      ...
      expect(modifiedContent2).toContain(
...
`;
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining("📋 TOC Generation Summary"),
      );
      expect(consoleSpy).toHaveBeenCalledWith(
...
`;
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('"filesProcessed": 1'),
      );
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('"filesModified": 1'),
      );
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('"filesSkipped": 0'),
      );
