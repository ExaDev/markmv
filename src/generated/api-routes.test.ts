/**
 * @file Tests for auto-generated REST API route definitions Verifies that API routes are properly
 *   generated with correct handlers and schemas
 */
...
describe('Auto-Generated API Routes', () => {
  ...
  describe('Route Structure Validation', () => {
    ...
    it('should have valid JSON Schema structure for schemas', () => {
      autoGeneratedApiRoutes.forEach((route) => {
        const inputSchema = route.inputSchema as Record<string, unknown>;
        const outputSchema = route.outputSchema as Record<string, unknown>;
